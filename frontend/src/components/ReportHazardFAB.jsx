  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="relative flex items-center gap-2 sm:gap-2.5 px-3.5 py-2.5 sm:px-5 sm:py-3.5 rounded-full bg-slate-900 text-white font-bold text-xs shadow-2xl border border-slate-700/80 hover:bg-slate-800 transition-all group active:scale-95"
      >
        <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-rose-500 text-white flex items-center justify-center shadow-xs group-hover:rotate-12 transition-transform">
          <Camera className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
        </div>
        
        <span className="tracking-wide text-[11px] sm:text-xs">Report Hazard</span>
