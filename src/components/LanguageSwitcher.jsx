      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`fixed sm:absolute z-50 top-16 right-2 left-2 sm:left-auto sm:top-auto sm:mt-2 w-auto sm:w-[410px] max-w-[420px] max-h-[82vh] sm:max-h-[580px] bg-white rounded-3xl shadow-2xl border border-slate-200/90 flex flex-col overflow-hidden backdrop-blur-2xl ${
